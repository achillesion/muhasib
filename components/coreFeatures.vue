  ...
  <section class="core-section core-section_roles">
    ...
    <div class="l-block l-block--full c-sliding-tabs">
      <div class="c-sliding-tabs__tabcontent">
        <div
          id="role0"
          class="c-sliding-tabs__panel c-role c-role--fight"
          data-wscitem="wsc_home_role"
        >
          <div class="c-sliding-tabs__background-wrapper">
            <div class="c-sliding-tabs__background-img">
              ...
              >
                <source
                  srcset="../assets/imgs/corefeatures/bgs/fight-bg.jpg"
                  media="(max-width: 420px)"
                />
                <img
                  src="../assets/imgs/corefeatures/bgs/fight-bg.jpg"
                  data-mediaslot="one"
                />
              </picture>
            </div>
          ...
          <div
            class="c-role__character"
            id="character0"
            data-src="../assets/imgs/corefeatures/fight.png"
          >
            <img
              class="character__static"
              src="../assets/imgs/corefeatures/fight.png"
              data-mediaslot="three"
            />
          </div>
        </div>
        <div
          id="role1"
          class="c-sliding-tabs__panel c-role c-role--Explore c-sliding-tabs__panel--active"
          data-wscitem="wsc_home_role"
        >
          <div class="c-sliding-tabs__background-wrapper">
            <div class="c-sliding-tabs__background-img">
          ...
          <div
            class="c-role__character"
            id="character0"
            data-src="../assets/imgs/corefeatures/explore.png"
          >
            <img
              class="character__static"
              src="../assets/imgs/corefeatures/explore.png"
              data-mediaslot="three"
            />
          </div>
        </div>
        <div
          id="role2"
          class="c-sliding-tabs__panel c-role c-role--spy"
          data-wscitem="wsc_home_role"
        >
          <div class="c-sliding-tabs__background-wrapper">
            <div class="c-sliding-tabs__background-img">
          ...
          <div
            class="c-role__character"
            id="character0"
            data-src="../assets/imgs/corefeatures/treasure.png"
          >
            <img
              class="character__static"
              src="../assets/imgs/corefeatures/treasure.png"
              data-mediaslot="three"
            />
          </div>
        </div>
        <div
          id="role3"
          class="c-sliding-tabs__panel c-role c-role--trade"
          data-wscitem="wsc_home_role"
        >
          <div class="c-sliding-tabs__background-wrapper">
            <div class="c-sliding-tabs__background-img">
          ...
          <div
            class="c-role__character"
            id="character0"
            data-src="../assets/imgs/corefeatures/trade.png"
          >
            <img
              class="character__static"
              src="../assets/imgs/corefeatures/trade.png"
              data-mediaslot="three"
            />
          </div>
        </div>
      </div>
      <div class="c-sliding-tabs__tabs">
        <ul>
          <li
            class="c-sliding-tab c-sliding-tab--fight"
            data-tab="#role0"
            data-wscitem="wsc_home_role"
          >
            ...
            <div class="c-sliding-tab__description">
              BEO has traditional elements of roleplay and exploration the MMO’s
              we love have, combined with the play to earn mechanics of
              blockchain technology making it the first of its kind.
            </div>
            <span aria-hidden="true" class="c-sliding-tab__hover"></span>
          </li>
          <li
            class="c-sliding-tab c-sliding-tab--Explore c-sliding-tab--active"
            data-tab="#role1"
            data-wscitem="wsc_home_role"
          >
          ...
          <li
            class="c-sliding-tab c-sliding-tab--spy"
            data-tab="#role2"
            data-wscitem="wsc_home_role"
          >
          ...
          <li
            class="c-sliding-tab c-sliding-tab--trade"
            data-tab="#role3"
            data-wscitem="wsc_home_role"
          >
...
setTimeout(function () {
  function convertAlphaMask(maskObj, dimensions) {
    ...
    (convertCanvas.width = dimensions.width),
      ...
      (RGBA = convertCtx.getImageData(
        0,
        0,
        dimensions.width,
        dimensions.height
      ));
    for (var i = 3, len = RGBA.data.length; i < len; i += 4)
      (RGBA.data[i - 1] = RGBA.data[i - 2] = RGBA.data[i - 3] = RGBA.data[i]),
        (RGBA.data[i] = 255);
    return RGBA;
  }
  ...
  function unmultiply(rgb, alphaData) {
    for (var i = 3, len = rgb.data.length; i < len; i += 4)
      (rgb.data[i] = alphaData[i - 1]),
        (rgb.data[i - 3] =
          rgb.data[i - 3] / (alphaData[i - 1] ? alphaData[i - 1] / 255 : 1)),
        (rgb.data[i - 2] =
          rgb.data[i - 2] / (alphaData[i - 1] ? alphaData[i - 1] / 255 : 1)),
        (rgb.data[i - 1] =
          rgb.data[i - 1] / (alphaData[i - 1] ? alphaData[i - 1] / 255 : 1));
    return rgb;
  }
  ...
  function getCancelAnimationFrame() {
    for (
      var vendors = ["ms", "moz", "webkit", "o"], x = 0;
      x < vendors.length;
      x++
    ) {
      if (window[vendors[x] + "CancelAnimationFrame"])
        return window[vendors[x] + "CancelAnimationFrame"];
      if (window[vendors[x] + "CancelRequestAnimationFrame"])
  ...
  function cssObjectToString(obj) {
    var res = [];
    for (var prop in obj)
      obj.hasOwnProperty(prop) && res.push(prop + ": " + obj[prop] + ";");
    return res.join("");
  }
    ...
    $.fn &&
      ...
      ($.fn.seeThru = function () {
        ...
        return this.each(function () {
          ...
          if (
            !args.length ||
            (1 === args.length && "[object Object]" === toString(args[0]))
          ) {
            ...
            $this.data("seeThru").ready(function () {
              $this.data("seeThru")[args[0]](args[1]),
                "revert" === args[0] && $this.data("seeThru", null);
            });
          }
        });
      });
  ...
  function TransparentVideo(video, options) {
    var posterframe,
      ...
      cancelAnimationFrame =
        window.cancelAnimationFrame || getCancelAnimationFrame(),
      ...
      drawFrame = function drawFrame(recurse) {
        ...
        if (lastDrawnFrameTime !== currentFrameTime && video.readyState > 1) {
          for (
            ...
            image.data[i] = options.alphaMask
              ? alphaData[i - 1]
              : Math.max(alphaData[i - 1], alphaData[i - 2], alphaData[i - 3]);
          display.putImageData(
            image,
            0,
            0,
            0,
      ...
      drawStaticMask = function (node) {
        ...
        (node.width = dimensions.width),
          ...
          options.alphaMask
            ? buffer.putImageData(
                convertAlphaMask(node, dimensions),
                0,
                dimensions.height
              )
            : buffer.drawImage(
    ...
    (this.startRendering = function () {
      ...
      (this.teardown = function () {
        ...
        for (var key in initialStyles)
          Object.prototype.hasOwnProperty.call(initialStyles, key) &&
    ...
    (dimensions.height && dimensions.width) ||
      (video.width || video.height
        ? video.height
          ? video.width
            ? ((dimensions.width = dimensions.width || elementDimensions.width),
              (dimensions.height =
                dimensions.height || elementDimensions.height / divisor))
            : ((dimensions.width =
                dimensions.width ||
                elementDimensions.height *
                  (video.videoWidth / Math.floor(video.videoHeight / divisor))),
              (dimensions.height =
        ...
        : ((dimensions.width = dimensions.width || video.videoWidth),
          (dimensions.height =
            dimensions.height || video.videoHeight / divisor))),
    ...
    for (var key in options.videoStyles)
      Object.prototype.hasOwnProperty.call(options.videoStyles, key) &&
  ...
  function SeeThru(DOMNode, options) {
    var self = this,
      ...
      canConstructEvents = (function () {
        try {
          return (
            !1 === new Event("submit", { bubbles: !1 }).bubbles &&
            !0 === new Event("submit", { bubbles: !0 }).bubbles
          );
        } catch (e) {
          return !1;
        }
    ...
    if (
      ...
      !this._video || "VIDEO" !== this._video.tagName)
    )
          ...
          function playSelfAndUnbind() {
            self._video.play(),
              self._options.poster
                ? self._seeThru
                    .getPoster()
                    .removeEventListener("click", playSelfAndUnbind)
                : self._seeThru
                    .getCanvas()
                    .removeEventListener("click", playSelfAndUnbind);
          }
          if (elementStore.has(this._video))
            throw new Error(
              "seeThru already initialized on passed video element!"
            );
          (this._seeThru = new TransparentVideo(this._video, this._options)),
            "clicktoplay" === this._options.start
              ? this._options.poster
                ? this._seeThru
                    .getPoster()
                    .addEventListener("click", playSelfAndUnbind)
                : this._seeThru
                    .getCanvas()
                    .addEventListener("click", playSelfAndUnbind)
              : "autoplay" === this._options.start &&
                options.poster &&
      ...
      _createClass(SlidingTabs, [
        {
          ...
          value: function () {
            function playCharacter() {
              var curRole = document.querySelector(
                  ".c-sliding-tabs__panel--active"
                ),
                curRoleVid = curRole.querySelector("video");
              curRoleVid &&
                curRoleVid.paused &&
                !hasPlayed &&
                (curRoleVid.play(), (hasPlayed = !0));
            }
            ...
            !(function () {
              ...
              if (windowWidth > 1023)
                for (var i = 0, len = deferVideos.length; i < len; i += 1) {
                  ...
                  if (videoSrc) {
                    let vueModified = videoSrc.replace("..", "/_nuxt");
                    var videoTag =
                      '<video class="c-video__defer character__video" playsinline muted><source src="' +
                      vueModified +
                    ...
                    var staticCharacter =
                      (new SeeThru(deferVideo, {
                        start: "external",
                        end: "stop",
                      })._init(),
                      deferVideos[i].querySelector(".character__static"));
              ...
              roleInView = (function (func, wait, immediate) {
                ...
                roleSection &&
                  (window.onscroll = function () {
                    var roleSectionRectTop =
                      roleSection.getBoundingClientRect().top;
                    roleSectionRectTop <= 0.5 * window.innerHeight &&
                    roleSectionRectTop > -300
                      ? playCharacter()
                      : pauseCharacter();
                  });
              }, 250);
            ...
            [].forEach.call(openModalButtons, function (el) {
              el.addEventListener("click", function (event) {
                ...
                body.classList.add("hero-modal--is-open"),
                  document
                    .querySelector("#bodyWrapper")
                    .insertAdjacentHTML("afterbegin", modal.outerHTML);
                var newModal = document.querySelector("#" + modalID),
                  closeButtons = newModal.querySelectorAll(
                    ".js-close-hero-modal"
                  );
                [].forEach.call(closeButtons, function (closeBtn) {
                  closeBtn.addEventListener("click", function (event) {
                    ...
                    $(modal).remove(),
                      body.classList.remove("hero-modal--is-open");
                  });
                }),
...
.c-sectiontitle__separator:after,
.c-sectiontitle__separator:before {
  width: 3px;
  height: 3px;
  background: #ee810b;
  content: "";
...
.c-sectiontitle--right .c-sectiontitle__text {
  margin-left: 0;
  margin-right: 20px;
}
...
.c-role.c-sliding-tabs__panel--active {
  z-index: 2;
}
...
.c-sliding-tabs__background-img {
  width: calc(100% + 50px);
  opacity: 0;
  position: absolute;
...
.c-objectfit--cover img {
  object-fit: cover;
}

.c-objectposition--center img {
...
.c-sliding-tab--active {
  padding-top: 15px;
  height: 260px;
}

.c-sliding-tab .c-sliding-tab__hoveroverlay,
.c-sliding-tab:before {
  content: "";
  display: block;
  position: absolute;
  top: 0;
  ...
  border-image-source: url(../assets/imgs/corefeatures/feature-bg.svg);
  border-image-slice: 50 fill;
  border-image-width: 50px;
}

.c-sliding-tab__title--horizontal,
.c-sliding-tab__title--vertical {
  color: #fbfeff;
  font-size: 16px;
  font-weight: 400;
  text-transform: uppercase;
...
.c-sliding-tab__title--vertical {
  ...
  opacity: 1;
  position: absolute;
  -webkit-transform: rotate(-90deg) translateX(-298px) translateY(6px);
  -moz-transform: rotate(-90deg) translateX(-298px) translateY(6px);
  -ms-transform: rotate(-90deg) translateX(-298px) translateY(6px);
  transform: rotate(-90deg) translateX(-298px) translateY(6px);
...
.c-sliding-tab__cta:before {
  content: "\E907";
  display: inline-block;
  vertical-align: middle;
  font-family: wtsc-icons;
  font-size: 22px;
  line-height: 1.4em;
  margin-right: 5px;
  text-shadow: 0 0 7px #c48100, 0 0 14px #c48100;
}

.c-sliding-tabs__panel--active .c-sliding-tabs__background-img {
  opacity: 1;
...
.c-role.c-sliding-tabs__panel--active .c-role__character {
  opacity: 1;
  -webkit-transform: translateX(0);
  -moz-transform: translateX(0);
  -ms-transform: translateX(0);
...
.c-sliding-tab--active .c-sliding-tab__cta {
  width: 170px;
  -webkit-transition-delay: 0.5s;
  transition-delay: 0.5s;
}
...
.c-sliding-tab--active .c-sliding-tab__cta,
.c-sliding-tab--active .c-sliding-tab__cta span,
.c-sliding-tab--active .c-sliding-tab__cta strong {
  opacity: 1;
  -webkit-transform: translateX(0);
  -moz-transform: translateX(0);
  -ms-transform: translateX(0);
...
span.c-sliding-tab__title--vertical,
h4.c-sliding-tab__title--horizontal {
...
.c-sliding-tab--active h4.c-sliding-tab__title--horizontal:after {
  content: "";
  height: 12px;
  display: block;
  width: 300px;
...
@media (min-width: 768px) {
  ...
  .c-sliding-tab__cta:before {
    ...
    font-size: 22px;
    margin-right: 24px;
    text-shadow: 0 0 7px rgb(196 129 0 / 0%), 0 0 14px rgb(196 129 0 / 0%);
    transition: all 0.4s cubic-bezier(0.165, 0.84, 0.44, 1);
    -moz-transition: all 0.4s cubic-bezier(0.165, 0.84, 0.44, 1);
    -webkit-transition: all 0.4s cubic-bezier(0.165, 0.84, 0.44, 1);
    -o-transition: all 0.4s cubic-bezier(0.165, 0.84, 0.44, 1);
...
@media (min-width: 1024px) {
  ...
  .c-sliding-tab__title--vertical {
    -webkit-transform: rotate(-90deg) translateX(-300px) translateY(12px);
    -moz-transform: rotate(-90deg) translateX(-300px) translateY(12px);
    -ms-transform: rotate(-90deg) translateX(-300px) translateY(12px);
    transform: rotate(-90deg) translateX(-300px) translateY(12px);
  }
  .c-sliding-tab__description,
  .c-sliding-tab__title--horizontal {
    margin-left: 72px;
  ...
  .c-sliding-tab--active .c-sliding-tab__title--vertical {
    opacity: 0;
  }
  .c-sliding-tab--active .c-sliding-tab__description,
  .c-sliding-tab--active .c-sliding-tab__title--horizontal {
    opacity: 1;
    -webkit-transform: translateX(0);
    -moz-transform: translateX(0);
    -ms-transform: translateX(0);
